...
internal class DuplicateProductMarkingException : RuntimeException(), LocalizableResource {
    override val resourceString: ResourceString = StringResource(R.string.feature_product_marking_duplicate_marking_exception)
}