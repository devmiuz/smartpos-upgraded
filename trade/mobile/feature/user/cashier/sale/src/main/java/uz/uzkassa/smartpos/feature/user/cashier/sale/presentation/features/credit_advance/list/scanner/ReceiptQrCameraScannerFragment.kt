...
import uz.uzkassa.smartpos.feature.user.cashier.sale.presentation.features.credit_advance.list.scanner.di.ReceiptQrCameraScannerComponent

import uz.uzkassa.smartpos.feature.user.cashier.sale.databinding.FragmentFeatureUserCashierRefundReceiptQrCameraScannerBinding as ViewBinding
...
internal class ReceiptQrCameraScannerFragment :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this) { presenter.handleResult("") }
    }
