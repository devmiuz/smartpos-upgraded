package uz.uzkassa.smartpos.trade.data.network.rest
...
import uz.uzkassa.smartpos.trade.data.network.rest.impl.retrofit.RetrofitInstance
...
class RestProviderImpl(
    ...
    private val retrofit: Retrofit by lazy {
        RetrofitInstance(okHttpInstance, servicesHolder).retrofit
    }
    ...
    override val cashTransactionRestService by lazy {
        CashTransactionRestService.instantiate(retrofit)
    }
    ...
    override val salesDynamicsRestService by lazy {
        SalesDynamicsRestService.instantiate(retrofit)
    }

    override val shiftReportRestService: ShiftReportRestService by lazy {
        ShiftReportRestService.instantiate(retrofit)
    }

    override val shiftRestService by lazy {
        ShiftRestService.instantiate(retrofit)
    }
    ...
    override val apayRestService by lazy {
        ApayRestService.instantiate(retrofit)
    }
}