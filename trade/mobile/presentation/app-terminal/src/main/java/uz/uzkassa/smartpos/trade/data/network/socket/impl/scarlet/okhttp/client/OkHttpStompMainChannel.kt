...
import uz.uzkassa.smartpos.trade.data.network.socket.impl.scarlet.okhttp.core.*
import uz.uzkassa.smartpos.trade.data.network.socket.impl.scarlet.okhttp.models.StompCommand
...
import uz.uzkassa.smartpos.trade.data.network.socket.impl.scarlet.okhttp.support.StompHeaderAccessor
...
class OkHttpStompMainChannel(
    ...
    override fun convertAndSend(
        ...
        val stompMessage: StompMessage = StompMessage.Builder()
            .withPayload(payload)
