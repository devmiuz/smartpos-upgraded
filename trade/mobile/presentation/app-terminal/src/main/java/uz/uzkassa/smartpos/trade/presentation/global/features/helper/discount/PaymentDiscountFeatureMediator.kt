package uz.uzkassa.smartpos.trade.presentation.global.features.helper.discount
...
class PaymentDiscountFeatureMediator(
    ...
    override var discountType: DiscountType by Delegates.notNull()
    ...
    private inner class FeatureRunnerImpl : PaymentDiscountFeatureRunner {
        override fun run(
            ...
            this@PaymentDiscountFeatureMediator.discountType = discountType
