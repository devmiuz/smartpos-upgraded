package uz.uzkassa.smartpos.trade.companion.presentation.global.navigation.navigator;
...
public class GlobalNavigator implements Navigator {
    ...
    public GlobalNavigator(FragmentActivity activity, int containerId) {
        this(activity, activity.getSupportFragmentManager(), containerId);
    }

    public GlobalNavigator(FragmentActivity activity, FragmentManager fragmentManager, int containerId) {
    ...
    protected void fragmentForward(Forward command) {
        ...
        if (fragment instanceof DialogFragment) {
            ((DialogFragment) fragment).show(fragmentManager, screen.getScreenKey());
            return;
        }
