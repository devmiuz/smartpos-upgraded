...
class CurrentCredentialParams(
    ...
    private val params: CredentialParams
        get() = if (userCredentialParams.isResumed) userCredentialParams
        else accountCredentialParams
    ...
    private class UserCredentialParams(
        ...
        init {
            userAuthPreference.accessToken = null
        }
