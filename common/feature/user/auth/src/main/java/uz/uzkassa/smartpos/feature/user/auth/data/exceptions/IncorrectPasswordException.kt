...
internal class IncorrectPasswordException : Exception(), LocalizableResource {

    override val resourceString =
        StringResource(R.string.fragment_feature_user_auth_supervisor_error_incorrect_password_message)
}