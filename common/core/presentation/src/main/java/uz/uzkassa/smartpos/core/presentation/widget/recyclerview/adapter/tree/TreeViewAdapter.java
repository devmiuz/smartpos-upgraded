...
@SuppressWarnings({"UnusedReturnValue", "unused", "unchecked", "WeakerAccess", "rawtypes"})
public class TreeViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NotNull final RecyclerView.ViewHolder holder, int position) {
        ...
        final TreeNode selectedNode = displayNodes.get(holder.getLayoutPosition());

        if (onTreeNodeListener != null)
            onTreeNodeListener.onBind(selectedNode, holder);
    ...
    public interface OnTreeNodeListener {
        ...
        void onBind(TreeNode node, RecyclerView.ViewHolder holder);
